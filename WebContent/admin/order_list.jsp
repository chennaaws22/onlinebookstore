		...
		<table  class="table table-bordered ">
			...
			<c:forEach var="bookOrder" items="${bookOrders}" varStatus="status">
				<tr>
					...
					<td><a class="btn btn-sm btn-primary mb-1 mr-1" href="view_order?orderId=${bookOrder.orderId}">Details</a><a class="btn btn-sm btn-primary mb-1 ml-1" href="edit_order?orderId=${bookOrder.orderId}">Edit</a> 
					<br/><a class="btn btn-sm btn-danger" href="delete_order?orderId=${bookOrder.orderId}" onClick="confirmDelete(${bookOrder.orderId})">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
		</div>
